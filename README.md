...
<h3 align="center">🚀 Lead Data Engineer | Cloud & Databricks Expert | Modern Data Solutions Architect</h3>
...
### 👩‍💻 About Me
- 🏗 **Designing Scalable Data Architectures & Lakehouse Solutions** with **Databricks, Delta Lake, Unity Catalog, Azure & Snowflake**  
- 🎯 **14+ years experience** in **Data Engineering, ETL Development, Data Warehousing, Cloud Data Platforms, and Database Development**  
- 🌱 Passionate about **data governance, production-grade pipelines, and metadata-driven automation**  
- 📍 **Based in Sweden 🇸🇪, open to opportunities across Sweden & EU**  
- 💡 Advocate for **women in tech, mentorship, and best practices in modern data engineering**

I help organizations **build secure, efficient, and compliant data solutions**, from **ETL pipelines and Lakehouse architectures to data product frameworks**. Experienced in **optimizing large-scale transformations, enforcing data contracts, and embedding governance in pipelines**.

**Key Highlights:**  
- ✅ **Modern Data Engineering:** Databricks Lakehouse, Delta Lake, Delta Live Tables, Unity Catalog  
- ☁ **Cloud & Data Platforms:** Azure, Snowflake, Synapse Analytics, Azure Data Factory  
- ⚡ **Optimizations & Governance:** CI/CD, metadata-driven automation, secure and compliant data workflows  
- 🤝 **Leadership & Mentorship:** Guiding teams in best practices, data architecture, and governance
...
- **Databricks Certified Data Engineer Professional**  
  📜 [View Certificate](https://github.com/snehasamita05/Certifications/blob/c677c710fd2495c1001a7e8823f90f49bae362f1/Databricks%20Certification_Professional%20pdf.png)
...
⚙️ Designed scalable ETL pipelines and structured raw-to-curated data flows  
...
💼 **LinkedIn:** [linkedin.com/in/sneha-samita](https://www.linkedin.com/in/sneha-samita)  
